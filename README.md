...
* [`src/ttgl/`](src/ttgl/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/ttgl/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `ttgl` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/ttgl/config.cljs) defaults to `true` in
